...
class Wallet:
    ...
    def sign(self, data):
        """
        Generate a signiture based on the data using the local private key
        """
    ...
    def calculate_balance(blockchain, address):
        ...
        The balance is found by adding the output values that belong to that address since the most recent transaction by that address
        """
